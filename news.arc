...
; put usernames of admins, separated by whitespace, in snapshots/admins
...
(= newsdir*  "snapshots/news/"
   storydir* "snapshots/news/story/"
   profdir*  "snapshots/news/profile/"
   votedir*  "snapshots/news/vote/")
